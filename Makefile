...
$(FIGDIR)/140320_exp_fits.pdf: \
		$(CODEDIR)/plots/x140320_NBD_Bax_BimBH3_unlab_Bax_titration/layout_140320.py \
		$(CODEDIR)/data/140320_NBD_Bax_BimBH3_unlab_Bax_titration.txt \
		$(CODEDIR)/util/fitting.py \
		$(CODEDIR)/util/plate_assay.py \
		$(CODEDIR)/util/__init__.py
	python $(CODEDIR)/plots/x140320_NBD_Bax_BimBH3_unlab_Bax_titration/layout_140320.py
	mv *.pdf $(FIGDIR)
