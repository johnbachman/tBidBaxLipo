...
layout = collections.OrderedDict([
        ...
        ('Bax 1.34 nM', ['A11', 'B11', 'C11']),
        ('Bax 2.67 nM', ['A10', 'B10', 'C10']),
        ('Bax 5.34 nM', ['A09', 'B09', 'C09']),
        ('Bax 10.69 nM',   ['A08', 'B08', 'C08']),
        ('Bax 21.38 nM',  ['A07', 'B07', 'C07']),
        ('Bax 42.75 nM',  ['A06', 'B06', 'C06']),
        ('Bax 53.44 nM',  ['A05', 'B05', 'C05']),
        ('Bax 106.88 nM',  ['A04', 'B04', 'C04']),
        ('Bax 213.75 nM', ['A03', 'B03', 'C03']),
        ('Bax 427.5 nM', ['A02', 'B02', 'C02']),
        ('Bax 855 nM', ['A01', 'B01', 'C01']),
        ])

data_path = os.path.dirname(sys.modules['tbidbaxlipo.data'].__file__)
timecourse_file = os.path.abspath(os.path.join(data_path,
                                        '130905_Bax43C_Timecourse.csv'))
triton_file = os.path.abspath(os.path.join(data_path,
                                        '130905_Bax43C_Triton.csv'))
...
def plot_two_exp_fits():
    #data = truncate_timecourses(norm_wells, 0, 100)
    data = norm_wells
